...
/*
 |------------------------------------------------------------
 | SSL untuk cloud database
 |------------------------------------------------------------
 | Aman dipanggil juga di lokal. Jika server cloud butuh SSL,
 | koneksi akan tetap siap.
 */
